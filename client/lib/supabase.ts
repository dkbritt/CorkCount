...
import { secureSupabase, isSupabaseConfigured as checkSupabaseConfig, isSupabaseInsecureUrl as checkSupabaseInsecureUrl } from "./secureSupabase";
...
export async function isSupabaseInsecureUrl(): Promise<boolean> {
  return await checkSupabaseInsecureUrl();
}
